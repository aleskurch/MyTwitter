...
console.log(twitter.getPage(0, 10, {author: 'Shakespeare', tags: ['flowers']}));
console.log(twitter.get('1'));
console.log(twitter.edit('1', {description: 'edited description'}));
console.log(twitter.edit('1', {a: 'aaa'}));
console.log(twitter.validate(twitter.get('1')));
console.log(twitter.validate({id: '2'}));
let addedPost = Object.assign({}, twitter.get('1'));
addedPost.id = '21';
console.log(twitter.add(addedPost));
console.log(twitter.remove('21'));
console.log(twitter.getPage());
...
console.log(twitter.add(postWithoutPhoto));
console.log(twitter.add(postWithoutPhoto));